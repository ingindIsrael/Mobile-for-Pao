...
const SwitchNavigator = createSwitchNavigator(
  ...
  return (
    <Stack.Navigator initialRouteName="LandingView">
      ...
      <Stack.Screen name="Home" component={HomeView} options={headerOptions1} />
      ...
      <Stack.Screen
        ...
        component={FilterDetailView}
        options={headerOptions2}
      />

      <Stack.Screen
        name="AdvanceFilterListView"
        component={AdvanceFilterListView}
        options={headerOptions2}
      />

      <Stack.Screen
        name="AdvanceFilterDetailView"
        component={AdvanceFilterDetailView}
        options={headerOptions2}
      />
      ...
      <Stack.Screen
        ...
        component={DetailedRatings}
        options={headerOptions3}
      />
      <Stack.Screen
        name="Root"
        component={RootBottomTabNavigation}
      ...
      <Stack.Group
        ...
        <Stack.Screen name="Menu" component={Menu} options={hideHeader} />
        <Stack.Screen
          name="AboutPrivacyView"
          component={AboutPrivacyView}
          options={headerOptions4}
        />
      </Stack.Group>
    </Stack.Navigator>
  );
